...
st.title("Automatic *Text Summarization* Engine powered by *Google Gemini* Large Langauge Model ✨")
st.subheader(
...
if st.sidebar.button("✨ Generate With Gemini ✨") :
    if not gemini_api_key:
        ...
        st.subheader("Generating The Summary With *Words :- {}*, Please Wait.....".format(num_words))
